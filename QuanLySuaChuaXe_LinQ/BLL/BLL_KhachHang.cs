                ...
                using (QuanLySuaChuaXeDataContext quanly_SuaChuaXe = new QuanLySuaChuaXeDataContext())
                {
                    var result =
                        ...
                        select new
                        {
                            ...
                            khachhang.GioiTinh_KhachHang,
                            khachhang.NgaySinh_KhachHang,
                            khachhang.SoDienThoai_KhachHang
                        };
            ...
            string sodienthoai_KhacHang)
        {
            try
            {
                using (QuanLySuaChuaXeDataContext quanly_SuaChuaXe = new QuanLySuaChuaXeDataContext())
                {
                    ...
                    quanly_SuaChuaXe.KhachHangs.InsertOnSubmit(khachhang);
                    quanly_SuaChuaXe.KhachHangs.Context.SubmitChanges();
                }
            }
            catch
            {
        ...
        public bool XoaKhachHang(string id_KhachHang)
        {
            try
            {
                using (QuanLySuaChuaXeDataContext quanly_SuaChuaXe = new QuanLySuaChuaXeDataContext())
                {
                    ...
                    quanly_SuaChuaXe.KhachHangs.DeleteAllOnSubmit(result);
