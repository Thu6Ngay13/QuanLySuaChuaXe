                ...
                using (QuanLySuaChuaXeDataContext quanly_SuaChuaXe = new QuanLySuaChuaXeDataContext())
                {
                    var result =
                        ...
                        select new
                        {
                            hd.ID_HopDong,
                            hd.Ten_HopDong,
                            hd.NgayBatDau_HopDong,
                            hd.NgayKetThuc_HopDong,
                            hd.GiaTri_HopDong,
                            hd.ID_Xe
                        };
                ...
                using (QuanLySuaChuaXeDataContext quanly_SuaChuaXe = new QuanLySuaChuaXeDataContext())
                {
                    var result = from hopdong in quanly_SuaChuaXe.HopDongs
                                 ...
                                 select new
                                 {
                                     hopdong.ID_HopDong,
                                     hopdong.Ten_HopDong,
                                     hopdong.NgayBatDau_HopDong,
                                     hopdong.NgayKetThuc_HopDong,
                                     hopdong.GiaTri_HopDong,
                                     hopdong.ID_Xe
                                 };
            ...
            string id_Xe)
        {
            try
            {
                using (QuanLySuaChuaXeDataContext quanly_SuaChuaXe = new QuanLySuaChuaXeDataContext())
                {
                    ...
                    quanly_SuaChuaXe.HopDongs.InsertOnSubmit(hopdong);
                    quanly_SuaChuaXe.HopDongs.Context.SubmitChanges();
                }
            }
            catch 
            {
        ...
        public bool XoaHopDong(string id_HopDong)
        {
            try
            {
                using (QuanLySuaChuaXeDataContext quanly_SuaChuaXe = new QuanLySuaChuaXeDataContext())
                {
                    ...
                    quanly_SuaChuaXe.HopDongs.DeleteAllOnSubmit(result);
