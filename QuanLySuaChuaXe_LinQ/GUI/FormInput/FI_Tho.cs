...
namespace GUI
{
    public partial class FI_Tho : Form
    {
        ...
        public FI_Tho()
        {
            ...
            DataTable dataTable = bll.LayTho();
            ...
            string id_NhomTho)
        {
            ...
            DataTable KhaNang_Table = bll_KhaNang.TimKhaNang(id_Tho, "");
        ...
        private void HienThiNhomTho()
        {
            ...
            DataTable nhomtho_Table = bll_NhomTho.LayNhomTho();
            ...
            try
            {
                ...
                switch (trangthai)
                {
                    ...
                    case 2:
                        ...
                        DataTable KhaNang_Table = bll_KhaNang.TimKhaNang(txt_ID_Tho.Text, "");
